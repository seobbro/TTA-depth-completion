...
from tta_main import adapt_ddp
...
parser.add_argument('--max_input_depth',
    type=float, default=None, help='Maximum depth input value')
...
parser.add_argument('--inner_iter',
    type=int, default=1, help='Maximum depth prediction value')
# Training settings
...
parser.add_argument('--w_loss_sparse_depth',
    type=float, default=1.0, help='Weight of weight decay loss')
parser.add_argument('--w_loss_smoothness',
    type=float, default=1.0, help='Weight of weight decay loss')
parser.add_argument('--w_loss_cos',
    type=float, default=1.0, help='Weight of weight decay loss')
parser.add_argument('--w_loss_robust',
    type=float, default=1.0, help='Weight of weight decay loss')
parser.add_argument('--loss_type',
    type=str, help='Defines forward and loss function type.')
# Evaluation settings
...
if __name__ == '__main__':
    ...
    try:
        mp.spawn(adapt_ddp, nprocs=torch.cuda.device_count(), join=True, args=(
            ...
            args.w_weight_decay,
            args.w_loss_sparse_depth,
            args.w_loss_smoothness,
            args.w_loss_cos,
            args.w_loss_robust,
            args.loss_type,
            # Evaluation settings
    ...
    #     do_loss_inpainting=args.do_loss_inpainting,
    #     do_loss_perceptual=args.do_loss_perceptual,
    #     do_loss_style=args.do_loss_style,
    #     warm_up=args.warm_up,
    #     from_scratch=args.from_scratch,
    #     box_occlusion_size=args.box_occlusion_size,
    #     # Augmentation settings
    ...
    #     w_loss_sparse_depth=args.w_loss_sparse_depth,
    #     w_loss_smoothness=args.w_loss_smoothness,
    #     w_loss_cos=args.w_loss_cos,
