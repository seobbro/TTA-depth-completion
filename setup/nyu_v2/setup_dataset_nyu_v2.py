...
parser.add_argument('--sparse_depth_distro_type', type=str, default='uniform')
...
# TODO: Add option to use subset of images
...
NYU_ROOT_DIRPATH = \
    os.path.join('data', 'nyu_depth_v2')
NYU_OUTPUT_DIRPATH = \
    os.path.join('data', 'nyu_v2_derived_500samples')
...
TRAIN_REF_DIRPATH = os.path.join('training', 'nyu_v2_500')
VAL_REF_DIRPATH = os.path.join('validation', 'nyu_v2_500')
TEST_REF_DIRPATH = os.path.join('testing', 'nyu_v2_500')
...
TRAIN_SUPERVISED_VALIDITY_MAP_OUTPUT_FILEPATH = \
    os.path.join(TRAIN_SUPERVISED_REF_DIRPATH, 'nyu_v2_train_validity_map_{}.txt'.format(args.sparse_depth_distro_type))
...
TRAIN_UNSUPERVISED_VALIDITY_MAP_OUTPUT_FILEPATH = \
    os.path.join(TRAIN_UNSUPERVISED_REF_DIRPATH, 'nyu_v2_train_validity_map_{}.txt'.format(args.sparse_depth_distro_type))
...
# train_supervised_validity_map_output_paths = []
...
# train_unsupervised_validity_map_output_paths = []
...
#                 train_unsupervised_validity_map_output_paths.append(validity_map_output_path)
...
#             train_supervised_validity_map_output_paths.append(validity_map_output_path)
...
# print('Storing {} training supervised validity_map file paths into: {}'.format(
#     len(train_supervised_validity_map_output_paths), TRAIN_SUPERVISED_VALIDITY_MAP_OUTPUT_FILEPATH))
# data_utils.write_paths(TRAIN_SUPERVISED_VALIDITY_MAP_OUTPUT_FILEPATH, train_supervised_validity_map_output_paths)
...
#     len(train_unsupervised_validity_map_output_paths), TRAIN_UNSUPERVISED_VALIDITY_MAP_OUTPUT_FILEPATH))
# data_utils.write_paths(TRAIN_UNSUPERVISED_VALIDITY_MAP_OUTPUT_FILEPATH, train_unsupervised_validity_map_output_paths)
